...
export default {
    ...
    methods:{
        ...
        savePatern(){
            axios.post('http://127.0.0.1:80/savepatern',{
                msg: this.textMsg,
        ...
        removePatern(patern){
            axios.post('http://127.0.0.1:80/removepatern',{patern_id: patern.id})
                .then(res => {
                    if (res.status === 200 && res.data === 'success') {
        ...
        async fetchClients(){
            try {
                const response = await axios.get('http://127.0.0.1:80/clients');
        ...
        async loadPatern(){
            ...
            try {
                const response = await axios.get('http://127.0.0.1:80/getpatern');
                console.log(response)
        ...
        mailing(){
            ...
            axios.post('http://127.0.0.1:80/mail',{
                userId: id,
